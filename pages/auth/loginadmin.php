                            ...
                            <div class="row justify-content-center">
                                <div class="col text-center">
                                    ...
                                    <div class="btn-group mb-5" role="group" aria-label="Basic outlined example">
                                        ...
                                        <button type="button" class="btn btn-lg btn-custom active"><a href="./loginadmin.php">Admin</a></button>
                                        <button type="button" class="btn btn-lg btn-custom"><a href="./loginmanager.php">Manager</a></button>
                                    </div>
                                </div>
                            </div>
                            <form action="post-login-admin.php" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input name="username-admin" type="text" class="form-control" placeholder="Masukkan username" required="required">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input name="password-admin" type="password" class="form-control" placeholder="Masukkan password" required="required">
                                        <div class="input-group-append">
                                            <span class="input-group-text">
                                                <i class="mdi mdi-check-circle-outline"></i>
                                            </span>
