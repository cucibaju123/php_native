                                    ...
                                    <?php } else { ?>
                                        <div class="row">
                                            <div class="col mt-1 text-right">
                                                <a href="../export_pembiayaan.php"><button class="btn btn-primary py-2">Print Semua</button></a>
                                            </div>
                                        </div>
                                                ...
                                                <?php foreach ($data_pembiayaan as $pembiayaan) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href=<?php echo "../printpembiayaan.php?id={$pembiayaan['id']}" ?>><button class="btn btn-danger">Print</button></a>
