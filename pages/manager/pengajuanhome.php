                                            ...
                                            <tbody>
                                                <?php foreach ($data_pembiayaan as $pembiayaan) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <?php if ($pembiayaan["manager_approved"] == 0) { ?>
                                                                    <form style="padding:0; margin:0;" action=<?php echo "./pengajuanupdate.php?id=" . $pembiayaan["id"] ?> method="POST">
                                                                        ...
                                                                        <button type="submit" name="manager_approved" value=1 class="btn btn-icons btn-success mx-1" data-toggle="tooltip" title="Setujui pembiayaan"><i class="mdi mdi-check"></i></button>
                                                                    </form>
                                                                    <form style="padding:0; margin:0;" action=<?php echo "./pengajuanupdate.php?id=" . $pembiayaan["id"] ?> method="POST">
                                                                        <input name="pembiayaan_id" type="hidden" value=<?php echo $pembiayaan["id"] ?>>
                                                                        <button type="submit" name="manager_approved" value=2 class="btn btn-icons btn-danger mx-1" data-toggle="tooltip" title="Setujui pembiayaan"><i class="mdi mdi-close"></i></button>
                                                                    </form>
                                                                <?php } elseif ($pembiayaan["manager_approved"] == 2) { ?>
