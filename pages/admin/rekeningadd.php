...
$data_nasabah = mysqli_fetch_all($result, MYSQLI_ASSOC);
?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row justify-content-center">
                                        <div class="col-md-7">
                                            <h4 class="mb-5"><strong>Tambah Rekening</strong></h4>
                                            <form class="forms-sample" action="./rekeningcreate.php" method="POST">
                                                <div class="form-group">
                                                    <label>No Rekening</label>
                                                    <input name="id" type="text" class="form-control" placeholder="Masukkan No Rekening" required>
                                                </div>
                                                <div class="form-group">
                                                    <label>Nasabah</label>
                                                    <select name="nasabah_id" type="text" class="form-control" required>
                                                        <?php foreach ($data_nasabah as $nasabah) { ?>
                                                            <option value=<?php echo $nasabah["id"] ?>><?php echo $nasabah["nama"] ?></option>
                                                        <?php } ?>
                                                    </select>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input name="setoran_awal" type="number" min=50000 class="form-control" placeholder="Masukkan Setoran Awal" required>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="tanggal_buka" class="form-control" type="date" placeholder="yyyy/mm/dd" required>
                                                </div>


                                                <button type="submit" class="btn btn-success mr-2" name="tambah_rekening">Tambah</button>
