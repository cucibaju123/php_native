...
if ($cari == null) {
    ...
    $result = mysqli_query($conn, "select t.*, n.nama from transaksi as t inner join nasabah as n on t.nasabah_id=n.id where n.nama like '%$cari%' order by t.id desc limit $offset, $no_of_records_per_page") or die(mysqli_error($conn));
}
