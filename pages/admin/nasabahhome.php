                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <a href="./nasabahadd.php"><button class="btn btn-primary btn-lg">Tambah Nasabah</button></a>
                                    <?php if (count($data_nasabah) < 1) { ?>
                                        <div class="p-3">
                                            ...
                                            <tbody>
                                                <?php foreach ($data_nasabah as $nasabah) { ?>
                                                    <tr>
                                                        ...
                                                        <td> <?php echo $nasabah["username"] ?> </td>
                                                        <td>
                                                            <a href=<?php echo "./nasabahedit.php?id={$nasabah['id']}" ?>><button class="btn btn-icons btn-light" data-toggle="tooltip" title="Edit data nasabah"><i class="mdi mdi-pencil"></i></button></a>
                                                            <a href=<?php echo "./nasabahdelete.php?id={$nasabah['id']}" ?>><button class="btn btn-icons btn-danger" data-toggle="tooltip" title="Hapus data nasabah" onclick="return confirm('Apakah Anda Yakin?')"><i class="mdi mdi-delete"></i></button></a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
