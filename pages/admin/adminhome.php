                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <a href="./adminadd.php"><button class="btn btn-primary btn-lg">Tambah Admin</button></a>
                                    <?php if (count($data_admin) < 1) { ?>
                                        <div class="p-3">
                                        ...
                                        <table class="table table-hover table-responsive-lg mt-4">
                                            ...
                                            <tbody>
                                                <?php foreach ($data_admin as $admin) { ?>
                                                    <tr>
                                                        <td> PGW-<?php echo $admin["id"] ?> </td>
                                                        <td> <?php echo $admin["nama"] ?> </td>
                                                        <td> <?php echo $admin["username"] ?> </td>
                                                        <td> <?php echo $admin["jabatan"] ?> </td>
                                                        <td>
                                                            <a href=<?php echo "./adminedit.php?id={$admin['id']}" ?>><button class="btn btn-icons btn-light" data-toggle="tooltip" title="Edit data admin"><i class="mdi mdi-pencil"></i></button></a>
                                                            <a href=<?php echo "./admindelete.php?id={$admin['id']}" ?>><button class="btn btn-icons btn-danger" data-toggle="tooltip" title="Hapus data admin" onclick="return confirm('Apakah Anda Yakin?')"><i class="mdi mdi-delete"></i></button></a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
