...
$result = mysqli_query($conn, "select r.*, n.nama, a.nama as admin_nama from rekening as r inner join nasabah as n on r.nasabah_id = n.id inner join admin as a on r.admin_id = a.id") or die(mysqli_error($conn));
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    <a href="./rekeningadd.php"><button class="btn btn-primary btn-lg">Tambah Rekening</button></a>
                                            ...
                                            <tbody>
                                                <?php foreach ($data_rekening as $rekening) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href=<?php echo "./rekeningedit.php?id={$rekening['id']}" ?>><button class="btn btn-icons btn-light" data-toggle="tooltip" title="Edit data rekening"><i class="mdi mdi-pencil"></i></button></a>
                                                            <a href=<?php echo "./rekeningdelete.php?id={$rekening['id']}" ?>><button class="btn btn-icons btn-danger" data-toggle="tooltip" title="Hapus data rekening" onclick="return confirm('Apakah Anda Yakin?')"><i class="mdi mdi-delete"></i></button></a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
