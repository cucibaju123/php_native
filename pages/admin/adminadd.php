                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row justify-content-center">
                                        <?php include "../inc/messageslogged.php" ?>
                                        <div class="col-md-7">
                                            <h4 class="mb-5"><strong>Tambah Admin</strong></h4>
                                            <form class="forms-sample" action="./admincreate.php" method="POST">
                                                <div class="form-group">
                                                    <label>Nama</label>
                                                    <input name="nama" type="text" class="form-control" placeholder="Masukkan nama admin" required>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input name="tanggal_lahir" type="date" class="form-control" placeholder="yyyy/mm/dd" required>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <button type="submit" class="btn btn-success mr-2" name="tambah_admin">Tambah</button>
